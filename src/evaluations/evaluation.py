...
#Evaluate(TopicsFound, ActualTopics, 1)
    ...
    for evalTopicKey in Eval_Dic_ActualTopics.keys():
       ...
       # if EvalSpec>
        ...
        # print('totalcountActual', str(totalcountActual))
    ...
    # print('=====================')
    # print("allInSpeciperTopicE :", allInSpeciperTopicE, " |  totalcountEasy :", totalcountEasy)
    # print('=====================')
    ...
    return_dict = {"RecallActual": recallActual,
